...
get_all_users(api_data['get_all_employees'], api_data['headers'])
post_create_user(api_data['post_create_employee'], api_data['headers'], api_data['employee_name'], api_data['age'],
                 api_data['salary'])
delete_user(api_data['delete_employee'], api_data['headers'], 1)
